...
<body>
	...
	<div class="container">
		<?php
		if (!empty($_POST['Genus_Name'])) //On est dans la page de formulaire
		{
			...
			//Vérification du character name
		   ...
		   {		
			...
			/*	var_dump($GenusName);
				...
				echo'<center><div class="alert alert-success" role="alert">The new quantitative character is adding !</div></center>';
