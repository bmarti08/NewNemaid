...
<body>
    ...
    <div class="container">
        ...
        <!-------------------------- Container --------------------------------->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">References view</h1>    
					<ol class="breadcrumb">
						<li><a href="index.php">Home</a> / <FONT color="#424242"> Database Management </FONT> / <FONT color="#424242"> References </FONT> / <FONT color="#BDBDBD"> References view</FONT>
						</li>
						<li class="active"></li>
					</ol>	
                </div>
								...
								while($data=$query->fetch()){	
									...
									<tr>
										...
										<td class="text-center">';
											...
											if($Admin == 1){											
												echo'
													<button data-toggle="modal" data-target="#edit_references" id="'.$data['Id_Biblio'].'" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-edit"></span> Details</button>
